 ...
 *
 * Three common loop patterns in REXX:
 *
 * 1. Accumulator: build up a result across iterations
 *    sum = 0; DO i = 1 TO n; sum = sum + i; END
 *
 * 2. Search: find the first item matching a condition, use LEAVE
 *    DO i = 1 TO n; IF item.i = target THEN LEAVE; END
 *
 * 3. Filter/Count: count items matching a condition
 *    count = 0; DO i = 1 TO n
 *      IF item.i > threshold THEN count = count + 1
 *    END
 *
 * Your task: Complete the three loop patterns below.
 */
