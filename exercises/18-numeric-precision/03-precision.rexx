 ...
 *
 * The number of digits REXX keeps affects division results:
 *
 *   NUMERIC DIGITS 5
 *   SAY 1/3    -- prints: 0.33333
 *
 *   NUMERIC DIGITS 10
 *   SAY 1/3    -- prints: 0.3333333333
 *
 * More digits = more precise results.
 *
 * Your task: Compute 1/3 at two different precisions and compare
